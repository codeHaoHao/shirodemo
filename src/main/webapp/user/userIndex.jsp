		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">用户首页</h4></li>
				</ul>
			...
			<div class="content">
				<div class="am-g">
					<!-- Row start -->
						<div class="am-u-md-3">
							<div class="card-box">
								<h4 class="header-title m-t-0 m-b-30" >今天网站新发文章总数</h4>
								...
								<div class="widget-chart-1 am-cf">
                                    ...
                                    <div class="widget-detail-1" style="float: left;">
                                        <h2 class="p-t-10 m-b-0" style="font-size: 32px"> 256 </h2>
                                        
                                    </div>
                                    
                                </div>
                                <a href="#"><p class="text-muted" align="right">查看今日新文章</p></a>
							</div>
						</div>
						<!-- col end -->
						<div class="am-u-md-3">
							<div class="card-box">
								<h4 class="header-title m-t-0 m-b-30">历史记录</h4>
								<div class="widget-box-2">
                                    <div class="widget-detail-2">
                                       <a href="${pageContext.request.contextPath }/returnHistoryInformation.action"> <span class="badge  pull-left m-t-20  am-round" style="color: #fff; background: #0e90d2;">你的浏览记录 <i class="zmdi zmdi-trending-up"></i> </span></a>
                                        <h2 class="m-b-0">  </h2>
                                        <p class="text-muted m-b-25">点击查看你的历史记录</p>
                                    </div>
						...
						<div class="am-u-md-3">
							<div class="card-box">
								<h4 class="header-title m-t-0 m-b-30">你所有文章的阅读总量</h4>
								<div class="widget-chart-1 am-cf">
                                    <div id="widget-chart-box-2" >
                                    </div>

                                    <div class="widget-detail-1" style="float: left;">
                                        <h2 class="p-t-10 m-b-0" style="font-size: 32px"> ${countOfReading } </h2>
                                        
                                    </div>
                                </div>
                                <a href="${pageContext.request.contextPath }/userMoments.action"><p class="text-muted" align="right">查看自己的文章</p></a>
							</div>
						</div>
						<!-- col end -->
						<div class="am-u-md-3">
							<div class="card-box">
								<h4 class="header-title m-t-0 m-b-30">您喜欢的文章</h4>
								<div class="widget-box-2">
                                    <div class="widget-detail-2">
                                        <span class="badge  pull-left m-t-20  am-round progress-bar-pink" style="color: #fff;">你喜欢的文章数<i class="zmdi zmdi-trending-up"></i> </span>
                                        
                                        <h2 class="m-b-0"> ${likeCounts } </h2>
                                       <a href="${pageContext.request.contextPath }/userLikeMoments.action"> <p class="text-muted m-b-25">查看自己喜欢的文章</p></a>
                                    </div>
