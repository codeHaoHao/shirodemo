...
<link rel="stylesheet" href="assets/css/core.css" />
	...
	<!--	<div class="am-g">-->
		...
		<div id="loadData" class="content-page">
			<!-- Start content -->
			<div class="content">
				<div class="card-box">
					<!-- Row start -->
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
											...
											<th class="table-title">所有人</th>
											<th class="table-type">类别</th>
											<th class="table-author am-hide-sm-only">标题</th>
											<th class="table-date am-hide-sm-only">发布时间</th>
											<th class="table-date am-hide-sm-only">阅读量</th>
											<th class="table-date am-hide-sm-only">转发自</th>
											<<th class="table-date am-hide-sm-only">是否删除</th>
              ...
              <tr v-for="(data,index) in dataList">
                ...
                <td>{{data.id}}</td>
                <td><a href="#">{{data.authorName}}</a></td>
                <td>{{data.categoryName}}</td>
                <td class="am-hide-sm-only">{{data.title}}</td>
                <td class="am-hide-sm-only">{{data.time|formatDate}}</td>
                <td class="am-hide-sm-only">{{data.amountOfReading}}</td>
                <td class="am-hide-sm-only">{{data.transpondByName}}</td>
                <td class="am-hide-sm-only">{{data.isdelete}}</td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button @click="cancelDeleteMoments(index)" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 取消删除</button>
                      <!-- <button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span class="am-icon-copy"></span> 复制</button> -->
                      <button @click="deleteMoments(index)" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
		...
		<script type="text/javascript" src="assets/admin/js/adminManagerMoments.js" ></script>
	</body>
